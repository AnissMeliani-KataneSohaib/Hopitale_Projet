			...
			<div class="container">
				<div class="main-header-left ">
					...
					<a class="header-brand" href="{{ url('/' . $page='index') }}">
						<img src="{{URL::asset('Dashboard/img/brand/logo-white.png')}}" class="desktop-dark">
						<img src="{{URL::asset('Dashboard/img/brand/logo.png')}}" class="desktop-logo">
						<img src="{{URL::asset('Dashboard/img/brand/favicon.png')}}" class="desktop-logo-1">
						<img src="{{URL::asset('Dashboard/img/brand/favicon-white.png')}}" class="desktop-logo-dark">
					</a>
